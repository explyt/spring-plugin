...
class PostConstructKotlinGenerateAction : BaseGenerateAction(GenerateMethodHandler()) {
    init {
        getTemplatePresentation().text = message("esprito.spring.action.post.construct.generate.kotlin")
    }
...
class PreDestroyKotlinGenerateAction : BaseGenerateAction(GenerateMethodHandler(false)) {
    init {
        getTemplatePresentation().text = message("esprito.spring.action.pre.destroy.kotlin")
    }

...
@Order(90)
class OtherBeanNodes(externalProjectsView: ExternalProjectsView, val beans: List<SpringBeanViewNode>) :
    ...
    override fun getName() = SpringCoreBundle.message("explyt.external.view.node.other")

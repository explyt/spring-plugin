 ...
 */
class SpringBoot4MockBeanMigrationInspection : SpringBaseUastLocalInspectionTool() {

    override fun checkField(field: UField, manager: InspectionManager, isOnTheFly: Boolean): Array<ProblemDescriptor> {
        if (!SpringBootUtil.isAtLeastSpringBoot4(field.javaPsi ?: return emptyArray())) return emptyArray()

 ...
 */
class SpringBoot4PropertyMigrationInspection : SpringBaseLocalInspectionTool() {
    ...
    override fun checkFile(
        ...
        if (!SpringBootUtil.isAtLeastSpringBoot4(file)) return ProblemDescriptor.EMPTY_ARRAY

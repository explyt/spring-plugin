...
/*
data class AiToolSpringProject(val modules: List<AiToolModule>, val properties: List<String>)

data class AiToolModule(val moduleName:String, val beans: List<AiToolBean>)

data class AiToolBean(val classQualifiedName: String, val classPath: String)*/

data class AiToolSpringProject(val beans: List<AiToolBean>, val applicationPropertyFiles: List<String>)

data class AiToolBean(val classQualifiedName: String, val filePath: String)

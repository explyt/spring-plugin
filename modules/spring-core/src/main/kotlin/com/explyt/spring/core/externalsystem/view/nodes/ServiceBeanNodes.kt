...
@Order(30)
class ServiceBeanNodes(externalProjectsView: ExternalProjectsView, val beans: List<SpringBeanViewNode>) :
    ...
    override fun getName() = SpringCoreBundle.message("explyt.external.view.node.service")

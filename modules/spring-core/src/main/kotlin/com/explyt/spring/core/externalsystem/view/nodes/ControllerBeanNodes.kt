...
@Order(10)
class ControllerBeanNodes(externalProjectsView: ExternalProjectsView, val beans: List<SpringBeanViewNode>) :
    ...
    override fun getName() = SpringCoreBundle.message("explyt.external.view.node.controller")

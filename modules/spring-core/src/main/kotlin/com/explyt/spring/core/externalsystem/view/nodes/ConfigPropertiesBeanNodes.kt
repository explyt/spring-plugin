...
@Order(80)
class ConfigPropertiesBeanNodes(externalProjectsView: ExternalProjectsView, val beans: List<SpringBeanViewNode>) :
    ...
    override fun getName() = SpringCoreBundle.message("explyt.external.view.node.configuration.properties")

...
@Order(20)
class RepositoryBeanNodes(externalProjectsView: ExternalProjectsView, val beans: List<SpringBeanViewNode>) :
    ...
    override fun getName() = SpringCoreBundle.message("explyt.external.view.node.repository")

...
class ControllerRunLineMarkerProviderTest : ExplytJavaLightTestCase() {
    ...
    fun testController() {
        myFixture.configureByFile("ProductController.java")
    ...
    fun testFeignClient() {
        myFixture.configureByFile("ProductClient.java")
        myFixture.doHighlighting()

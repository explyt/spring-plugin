...
import com.explyt.spring.web.inspections.OpenApiYamlUnresolvedReferenceInspection
import org.intellij.lang.annotations.Language

class OpenApiYamlUnresolvedReferenceInspectionTest : ExplytInspectionJavaTestCase() {

    override val libraries: Array<TestLibrary> = arrayOf(TestLibrary.springWeb_6_0_7)

    override fun setUp() {
        super.setUp()
        myFixture.enableInspections(OpenApiYamlUnresolvedReferenceInspection::class.java)
    }

    fun testOk() {
        @Language("yaml") val text = """
            openapi: "3.0.0"
            paths:
              /schemas:
                post:
    ...
    companion object {
        const val FILENAME = "openapi.yaml"
        const val REF = "\$ref"
    }

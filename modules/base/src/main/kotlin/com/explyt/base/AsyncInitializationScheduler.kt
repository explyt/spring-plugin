...
/**
 * Runs one deferred initialization at a time, closing races at the producer hand-off boundary.
 *
...
internal class AsyncInitializationScheduler(
    ...
    fun schedule() {
        ...
        try {
            ...
            // No task was accepted, so allow a later producer to retry without surfacing the rejection on the EDT.
            running.set(false)
        }
    }

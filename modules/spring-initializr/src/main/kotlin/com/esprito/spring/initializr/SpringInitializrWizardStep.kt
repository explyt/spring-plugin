...
class SpringInitializrWizardStep(private val context: WizardContext) : ModuleWizardStep() {
    private var serverUrl = getPropertyValue("esprito.spring.initializr.property.url")
    ...
    private fun getActiveDirectory(): File? {
        val path = getPropertyValue("esprito.spring.initializr.property.location")
    ...
    private fun addAction(textFieldLocation: TextFieldWithBrowseButton) {
            ...
            override fun onFileChosen(chosenFile: VirtualFile) {
                ...
                if (path.isNotBlank()) {
                    ...
                    PropertiesComponent.getInstance()
                        .setValue("esprito.spring.initializr.property.location", chosenFile.path)
                }
            }
        })
        ...
        textFieldLocation.addDocumentListener(object : DocumentListener {
            ...
            fun warn() {
                ...
                PropertiesComponent.getInstance()
                    .setValue("esprito.spring.initializr.property.location", path)
    ...
    private fun urlAction(labelUrl: JLabel) {
        ...
        if (!result.isNullOrBlank()) {
            serverUrl = result
            PropertiesComponent.getInstance().setValue("esprito.spring.initializr.property.url", serverUrl)
        }

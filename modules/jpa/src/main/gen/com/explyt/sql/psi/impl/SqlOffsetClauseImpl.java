...
import com.explyt.sql.psi.SqlOffsetClause;
...
public class SqlOffsetClauseImpl extends ASTWrapperPsiElement implements SqlOffsetClause {

    public SqlOffsetClauseImpl(@NotNull ASTNode node) {
        super(node);
    }

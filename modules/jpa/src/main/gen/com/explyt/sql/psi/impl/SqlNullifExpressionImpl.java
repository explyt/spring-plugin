...
import com.explyt.sql.psi.SqlNullifExpression;
...
public class SqlNullifExpressionImpl extends SqlExpressionImpl implements SqlNullifExpression {

    public SqlNullifExpressionImpl(@NotNull ASTNode node) {
        super(node);
    }

...
import com.explyt.sql.psi.SqlInItem;
...
public class SqlInItemImpl extends ASTWrapperPsiElement implements SqlInItem {

    public SqlInItemImpl(@NotNull ASTNode node) {
        super(node);
    }

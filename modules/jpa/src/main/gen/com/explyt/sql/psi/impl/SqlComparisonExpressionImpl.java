...
import com.explyt.sql.psi.SqlComparisonExpression;
...
public class SqlComparisonExpressionImpl extends SqlExpressionImpl implements SqlComparisonExpression {

    public SqlComparisonExpressionImpl(@NotNull ASTNode node) {
        super(node);
    }

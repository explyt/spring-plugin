...
import com.explyt.sql.psi.SqlExistsExpression;
...
public class SqlExistsExpressionImpl extends SqlExpressionImpl implements SqlExistsExpression {

    public SqlExistsExpressionImpl(@NotNull ASTNode node) {
        super(node);
    }

...
public interface SqlTypes {
    ...
    IElementType CONSTRUCTOR_ARGUMENTS_LIST = new SqlElementType("CONSTRUCTOR_ARGUMENTS_LIST");
    IElementType CONSTRUCTOR_EXPRESSION = new SqlElementType("CONSTRUCTOR_EXPRESSION");
    ...
    IElementType ENTITY_ACCESS = new SqlElementType("ENTITY_ACCESS");
    ...
    IElementType FULLY_QUALIFIED_CONSTRUCTOR = new SqlElementType("FULLY_QUALIFIED_CONSTRUCTOR");
    ...
    IElementType MAP_BASED_REFERENCE_EXPRESSION = new SqlElementType("MAP_BASED_REFERENCE_EXPRESSION");
    ...
    class Factory {
        public static PsiElement createElement(ASTNode node) {
            ...
            if (type == ADDITIVE_EXPRESSION) {
                ...
                return new SqlConstructorArgumentsListImpl(node);
            } else if (type == CONSTRUCTOR_EXPRESSION) {
                return new SqlConstructorExpressionImpl(node);
                ...
                return new SqlEntityAccessImpl(node);
                ...
                return new SqlFullyQualifiedConstructorImpl(node);
                ...
                return new SqlMapBasedReferenceExpressionImpl(node);

...
public class SqlVisitor extends PsiElementVisitor {
    ...
    public void visitConstructorArgumentsList(@NotNull SqlConstructorArgumentsList o) {
        visitPsiElement(o);
    }

    public void visitConstructorExpression(@NotNull SqlConstructorExpression o) {
        visitExpression(o);
    }
    ...
    public void visitEntityAccess(@NotNull SqlEntityAccess o) {
        visitPsiElement(o);
    }
    ...
    public void visitFullyQualifiedConstructor(@NotNull SqlFullyQualifiedConstructor o) {
    ...
    public void visitMapBasedReferenceExpression(@NotNull SqlMapBasedReferenceExpression o) {
        visitReferenceExpression(o);
    }

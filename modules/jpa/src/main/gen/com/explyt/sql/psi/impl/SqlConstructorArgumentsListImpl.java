...
public class SqlConstructorArgumentsListImpl extends ASTWrapperPsiElement implements SqlConstructorArgumentsList {

    public SqlConstructorArgumentsListImpl(@NotNull ASTNode node) {
        super(node);
    }

...
import com.explyt.sql.psi.SqlLikeExpression;
...
public class SqlLikeExpressionImpl extends SqlExpressionImpl implements SqlLikeExpression {

    public SqlLikeExpressionImpl(@NotNull ASTNode node) {
        super(node);
    }

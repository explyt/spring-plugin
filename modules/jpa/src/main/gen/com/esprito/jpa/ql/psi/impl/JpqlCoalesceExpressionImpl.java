...
import com.esprito.jpa.ql.psi.JpqlCoalesceExpression;
...
public class JpqlCoalesceExpressionImpl extends JpqlExpressionImpl implements JpqlCoalesceExpression {

  public JpqlCoalesceExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

...
import com.esprito.jpa.ql.psi.JpqlUpdateItem;
...
public class JpqlUpdateItemImpl extends ASTWrapperPsiElement implements JpqlUpdateItem {

  public JpqlUpdateItemImpl(@NotNull ASTNode node) {
    super(node);
  }

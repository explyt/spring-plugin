...
import com.esprito.jpa.ql.psi.JpqlHavingClause;
...
public class JpqlHavingClauseImpl extends ASTWrapperPsiElement implements JpqlHavingClause {

  public JpqlHavingClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

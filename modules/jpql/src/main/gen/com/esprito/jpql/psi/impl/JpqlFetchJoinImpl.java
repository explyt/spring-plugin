...
public class JpqlFetchJoinImpl extends ASTWrapperPsiElement implements JpqlFetchJoin {

  public JpqlFetchJoinImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JpqlVisitor visitor) {
    visitor.visitFetchJoin(this);
  }

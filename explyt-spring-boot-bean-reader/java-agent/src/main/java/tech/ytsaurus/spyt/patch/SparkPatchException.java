 ...
 * under the License.
 *
 * Original source code: https://github.com/ytsaurus/ytsaurus-spyt/blob/feature/spark-3.5.x_support/spark-patch/src/main/java/tech/ytsaurus/spyt/patch/SparkPatchException.java
 */
